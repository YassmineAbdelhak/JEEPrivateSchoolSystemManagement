    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        PrintWriter out = response.getWriter();
            try {
                ...
                stmt.executeUpdate("update students set first_name='"+first_name+"', last_name='"+last_name+"', email='"+email+"', telephone='"+telephone+"', groupe='"+groupe+"', level='"+level+"' where idstudents='"+id+"'");
